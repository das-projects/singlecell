...
def basic_analysis(filename):
    ...
    adata.write("./write/result_130K_gpu_umap.h5ad")
    # plotting
    sc.pl.umap(adata, color="louvain", save="_130K_gpu_umap.png")
    sc.pl.rank_genes_groups(adata, save="_130K_gpu_umap.pdf")
